      ...
      <div className="input">
        <div className="input-con" style={{ zIndex: openDrop ? 50 : 0 }}>
          ...
          >
            ...
            <div
              className={`dropDownButtons absolute bg-white shadow w-full text-txt overflow-hidden opacity-0 invisible top-0 mt-5 left-0 ml-5 z-10 rounded-sm  ${
